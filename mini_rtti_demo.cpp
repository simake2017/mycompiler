...
// =============================================================================
// 编译：  ./minicc ./mini_rtti_demo.cpp -o ./mini_rtti_demo.s
// 组装：  clang++-18 ./mini_rtti_demo.s -o /tmp/demo && /tmp/demo
// 看RTTI：grep "_ZTI\|type_name" ./mini_rtti_demo.s
// 看cast：grep "__minicc_dynamic_cast" ./mini_rtti_demo.s
//
